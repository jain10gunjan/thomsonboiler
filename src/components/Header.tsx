...
const images = [
  "_next/static/media/1.6e2dc79f.png",
  "_next/static/media/71.fd663f6d.png",
  "_next/static/media/10.aa56c115.png",
...
export default function SlidingImagesHero() {
  ...
  // Slide to the next image every 5 seconds
  useEffect(() => {
      ...
      <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          ...
          <div className="mt-7 grid gap-3 w-full sm:inline-flex">
            <a
              className="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-orange-600 text-white hover:bg-orange-700 focus:outline-none focus:bg-orange-700 disabled:opacity-50 disabled:pointer-events-none"
              href="/contact"
            >
              Get started
              <svg
