              ...
              <div className="flex gap-x-5">
                ...
                <div className="grow">
                  ...
                  <p className="mt-1 text-neutral-400">
                    ...
                    our team and looking htmlFor talented individuals like you
                    to join us.
                  </p>
                  <p className="mt-2">
                    <a
                      className="group inline-flex items-center gap-x-2 font-medium text-sm text-[#ff8400] decoration-2 hover:underline focus:outline-none focus:underline"
                      href="#"
                    >
                      Job openings
                      <svg
